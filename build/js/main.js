...
headerLinks.forEach(function (item, index, links) {
...
document.addEventListener("DOMContentLoaded", function () {
  var preloaderImage = document.querySelector(".js-preloader__image");
  var allImg = document.body.querySelectorAll("img");
  var offset = 80;
  var path = offset * 2;
  var startX = -offset;
  var startY = offset;
  var loadedImages = 0;
  var percentForOneImage = path / allImg.length;
  var currentPercent = 0;
  for (var i = 0; i < allImg.length; i++) {
    var element = allImg[i];
  ...
  function loadImage() {
    ...
    preloaderImage.style.transform = "translate(".concat(startX, "vw,").concat(startY, "vh)");
    if (currentPercent >= path) {
      var preloader = preloaderImage.closest(".preloader");
      setTimeout(function () {
...
(function () {
  ...
  var scrollProgressButton = canvas.getContext("2d");
  var Circle = /*#__PURE__*/function () {
    ...
    _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Circle, [{
      ...
      value: function draw() {
        ...
        this.ctx.beginPath();
        this.ctx.arc(26, 26, this.radius, this.start + this.k * this.x, this.start + this.pi * 2, false);
        ...
        this.ctx.closePath();
        this.ctx.beginPath();
        this.ctx.arc(26, 26, this.radius, this.start, this.start + this.k * this.x, false);
        this.ctx.lineWidth = 1;
        this.ctx.lineCap = "round";
        ...
        if (isMobileMode()) {
          ...
          this.ctx.fillText("".concat(this.x, "%"), 24, 30);
          this.ctx.closePath();
        }
      }
    }, {
  ...
  function getScrollPercent() {
    var currentPositionBottomPx = (window.pageYOffset || document.documentElement.scrollTop) + window.innerHeight;
    var percent = Math.floor(currentPositionBottomPx * 100 / document.documentElement.scrollHeight);
    return percent;
  }
...
/* harmony import */ var _components_preloader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/preloader */ "./src/js/components/preloader.js");
/* harmony import */ var _components_preloader__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_components_preloader__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _components_scroll_up__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/scroll-up */ "./src/js/components/scroll-up.js");
